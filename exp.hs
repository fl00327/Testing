...
-- Integer , Float , Double , Char, Bool, Tuple as list

bigFloat = 3.999999999 + 0.000000005
...
modEx = mod 5 4
-- if we want to do it like this we can do infix operator
modEx2 = 5 `mod` 4
...
-- so the sqrt is in float as we saw
